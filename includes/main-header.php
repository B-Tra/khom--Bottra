...
<div class="logo">
	...
	<h2 style="font-size:50px; padding-left:40px;">T-Store</h2>
...
if(!empty($_SESSION['cart'])){
	...
	?>
			...
			<div class="clearfix cart-total">
				...
				<a href="my-cart.php" class="btn btn-upper btn-primary btn-block m-t-20">My Card</a>	
			</div><!-- /.cart-total-->
...
<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
			...
			<div class="clearfix cart-total">
				...
				<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20">Continue To Shoping</a>	
			</div><!-- /.cart-total-->
